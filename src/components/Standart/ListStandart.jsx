...
<section className='section'>
      ...
      <div className={heroCss.repairBlock}>
        ...
        <ul>
            ...
            <li className={heroCss.serviceListPrice}>
              <p className={heroCss.serviceTitlePrice}>Заміна роз’ємів зарядки:</p>
              <p className={heroCss.serviceTitleSpan}>від 300 грн</p>
            </li>
            <li className={heroCss.serviceListPrice}>
              <p className={heroCss.serviceTitlePrice}>Розблокування облікового запису (пошта):</p>
              <p className={heroCss.serviceTitleSpan}>від 500 грн</p>
            </li>
            <li className={heroCss.serviceListPrice}>
              <p className={heroCss.serviceTitlePrice}>Розблокування облікового запису (Mi):</p>
