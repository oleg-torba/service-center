  ...
  return (
    ...
    <div >
      <section className="section">
        <div className={heroCss.mainTitleBlock}>
          ...
          <span className={heroCss.repairTitleSecond}>
            Ми - команда професіоналів, готова повернути Ваш телефон до життя!
            Проведемо ремонт телефону у Львові, Сумах, Рівному!
          </span>
        </div>
      </section>
      ...
      <div className={heroCss.serviceBlock}>
        ...
        <ul className={heroCss.service}>
            <li className={heroCss.serviceList}>
              <p className={heroCss.serviceTitleSecond}>Досвідчена команда фахівців</p>

            </li>
            <li className={heroCss.serviceList}>
              <p className={heroCss.serviceTitleSecond}>Оригінальні комплектуючі</p>
            </li>
            <li className={heroCss.serviceList}>
              <p className={heroCss.serviceTitleSecond}>Швидкість обслуговування</p>
            </li>
            <li className={heroCss.serviceList}>
